...
def _case_summary(
    ...
    return {
        ...
        "sub_category_id": str(case.sub_category_id) if case.sub_category_id else None,
        ...
        "frappe_last_error": case.frappe_last_error,
        ...
        "frappe_routing_reason": case.frappe_routing_reason,
        "frappe_last_workflow_pull_at": case.frappe_last_workflow_pull_at,
        "frappe_reply_approval_status": case.frappe_reply_approval_status,
        "frappe_reply_text_snapshot": case.frappe_reply_text_snapshot,
        "frappe_disposal_outcome": case.frappe_disposal_outcome,
        "frappe_ai_eligible": case.frappe_ai_eligible,
        "frappe_inquiry_findings": case.frappe_inquiry_findings,
        "frappe_school_version": case.frappe_school_version,
