...
CUSTOM_FIELDS: tuple[dict[str, Any], ...] = (
    ...
    {
        "fieldname": "custom_routing_section",
        "label": "Deomee Routing",
        "fieldtype": "Section Break",
        "insert_after": "custom_ai_eligible",
        "collapsible": 1,
    },
    {
        "fieldname": "custom_deomee_routing_status",
        "label": "Routing Status",
        "fieldtype": "Select",
        "options": "Not Routed\nPlanned\nRouted\nManual Assignment Preserved\nFailed",
        "insert_after": "custom_routing_section",
        "read_only": 1,
        "in_standard_filter": 1,
    },
    {
        "fieldname": "custom_deomee_target_team",
        "label": "Target Complaint Team",
        "fieldtype": "Data",
        "insert_after": "custom_deomee_routing_status",
        "read_only": 1,
        "in_standard_filter": 1,
    },
    {
        "fieldname": "custom_deomee_officer_id",
        "label": "Deomee Officer ID",
        "fieldtype": "Data",
        "insert_after": "custom_deomee_target_team",
        "read_only": 1,
        "hidden": 1,
    },
    {
        "fieldname": "custom_deomee_officer_name",
        "label": "Responsible Officer",
        "fieldtype": "Data",
        "insert_after": "custom_deomee_officer_id",
        "read_only": 1,
        "in_standard_filter": 1,
    },
    {
        "fieldname": "custom_deomee_officer_role",
        "label": "Responsible Officer Role",
        "fieldtype": "Data",
        "insert_after": "custom_deomee_officer_name",
        "read_only": 1,
    },
    {
        "fieldname": "custom_deomee_officer_mobile",
        "label": "Responsible Officer Mobile",
        "fieldtype": "Data",
        "insert_after": "custom_deomee_officer_role",
        "read_only": 1,
    },
    {
        "fieldname": "custom_deomee_routing_reason",
        "label": "Routing Reason",
        "fieldtype": "Small Text",
        "insert_after": "custom_deomee_officer_mobile",
        "read_only": 1,
    },
    {
