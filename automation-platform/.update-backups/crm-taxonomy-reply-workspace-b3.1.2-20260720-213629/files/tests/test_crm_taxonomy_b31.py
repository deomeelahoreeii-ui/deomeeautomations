...
def test_taxonomy_active_columns_use_supported_sqlmodel_index_metadata() -> None:
    assert ComplaintCategory.__table__.c.active.index is True
    assert ComplaintSubcategory.__table__.c.active.index is True
